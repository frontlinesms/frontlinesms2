...
class BootStrap {
	...
	def init = { servletContext ->
		...
		if (Environment.current == Environment.DEVELOPMENT) {
			...
			new SmslibFconnection(name:"COM4", port:'COM4', baud:9600, pin: 1149).save(failOnError:true)
			new SmslibFconnection(name:"COM5", port:'COM5', baud:9600, pin: 1149).save(failOnError:true)
