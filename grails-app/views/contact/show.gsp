...
<html>
    ...
    <body>
		<g:form name="contact-details">
			...
			<div class="buttons">
				...
				<g:if test="${contactInstance.id}">
					<g:actionSubmit class="update" action="update" value="${message(code: 'default.button.save.label', default: 'Save')}"/>
						<g:actionSubmit id="btn_delete" class="single-action delete" action="deleteContact" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('Delete ${contactInstance.name}')"/>
						<a id="btn_delete_all" class="multi-action delete hide"> Delete All</a>
				</g:if>
			  	<g:else>
			...
			<div class="multi-action hide" id="count"></div>
			<div class="field">
