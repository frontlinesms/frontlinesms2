			...
			<g:form name="contact-details">
				...
				<div class="basic-info field">
					...
					<g:if test="${contactInstance?.primaryMobile}">
						<g:remoteLink controller="quickMessage" action="create" params="[configureTabs: 'tabs-1,tabs-3, tabs-4', recipients: contactInstance?.primaryMobile]" onSuccess="launchMediumWizard('Send Message', data, 'Send', null, true);addTabValidations();" class="send-message">
				...
				<div class="basic-info field">
					...
					<g:if test="${contactInstance?.secondaryMobile}">
						<g:remoteLink controller="quickMessage" action="create" params="[configureTabs: 'tabs-1,tabs-3, tabs-4', recipients: contactInstance?.secondaryMobile]" onSuccess="launchMediumWizard('Send Message', data, 'Send', null, true);addTabValidations();" class="send-message">
							<img src='${resource(dir:'images/icons',file:'send.gif')}' />
						</g:remoteLink>
					</g:if>
				</div>
