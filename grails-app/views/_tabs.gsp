...
<ul id="main-tabs">
	<li><g:link class="tab ${params.controller=='message'?'selected':''} ${params.controller=='folder'?'selected':''} ${params.controller=='poll'?'selected':''}" url="${[controller:'message']}" id="goto-messages">Messages</g:link></li>
