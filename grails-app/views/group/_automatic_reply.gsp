...
<g:javascript src="group/generate-message.js"/>
	...
	<div>
		...
		<g:checkBox name="reply" value="joinReplyMessage" id="join_reply_checkbox" checked='false'/> Send an automatic reply to join requests (max 255 character)
	...
	<div>
		...
		<g:checkBox name="reply" value="leaveReplyMessage" id="leave_reply_checkbox" checked='false'/> Send an automatic reply to leave requests (max 255 character)
