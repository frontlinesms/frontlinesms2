...
function initializePopup() {
	$("#modalBox.help #help-index li a").click(goToSectionFromIndex);
...
function _goToSection(menuItem, prefixTrimLength) {
	...
	$("#help-content").load(url_root + "help/" + section.substring(prefixTrimLength), function() {
		if(!jQuery.browser.msie || jQuery.browser.version > 7) {
...
function goToSectionFromIndex() {
	return _goToSection($(this), 0);
}

function goToSection() {
	return _goToSection($(this), 3);
}
</r:script>
<div id="help-index">
