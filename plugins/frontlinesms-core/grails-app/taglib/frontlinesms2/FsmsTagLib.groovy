...
class FsmsTagLib {
	...
	def quickMessage = { att ->
		...
		att.onSuccess = "hideThinking(); mediumPopup.launchMediumWizard(i18n('wizard.quickmessage.title'), data, i18n('wizard.send'), true); selectSubscriptionGroup(${att.groupId});"
