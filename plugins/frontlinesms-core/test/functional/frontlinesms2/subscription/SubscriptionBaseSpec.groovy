...
class SubscriptionBaseSpec extends grails.plugin.geb.GebSpec {
	static createTestSubscriptions() {
		...
		def campingSub = new Subscription(name:"Camping Subscription", group:campingGroup, defaultAction:Action.JOIN).save(failOnError:true)
		...
		def footballSub = new Subscription(name:"Football Updates Subscription", group:campingGroup, defaultAction:Action.JOIN).save(failOnError:true)
