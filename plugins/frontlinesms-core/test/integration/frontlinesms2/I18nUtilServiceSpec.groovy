...
class I18nUtilServiceSpec extends IntegrationSpec {
	...
	def 'get a list of available translations'() {
		expect:
			i18nUtilService.getAllTranslations() == [de:'Deutsch', '':'English', es:'Español', fr:'French', in_ID:'Indonesian', jp:'Japanese', sw:'Kiswahili', pt:'Português', ru:'Русский', ar:'العربية']
	}
