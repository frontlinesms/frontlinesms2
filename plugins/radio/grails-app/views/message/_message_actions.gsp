...
<div id="message-detail-buttons">
	...
	<g:elseif test="${ownerInstance}">
		<g:remoteLink class="msg-btn btn" controller="${ownerInstance.shortName}" action="restore" params="[id: ownerInstance?.id]" onSuccess="function() { window.location = location}" >
