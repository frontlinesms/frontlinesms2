...
<g:submitToRemote url="[controller:'radioShow', action:'wordCloudStats', params:[id:ownerInstance?.id]]" onSuccess="showWordCloud(data)" class="btn" name="show-wordcloud-btn" value="${message(code:'wordcloud.show.cloud')}" action="wordCloudStats"/>
