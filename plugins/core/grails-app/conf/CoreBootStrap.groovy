...
class CoreBootStrap {
	...
	private def dev_initWebConnections() {
		...
		def extCmd = new WebConnection(name:'Through To Server', keyword:new Keyword(value:'FORWARD'), url:"http://192.168.0.200:9091/webservice-0.1/message/get", httpMethod:WebConnection.HttpMethod.GET)
