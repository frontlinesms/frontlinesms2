<ul class="header-buttons">
	<li><g:remoteLink class="section-action-button btn" controller="quickMessage" action="create" onLoading="showThinking();" onSuccess="hideThinking(); launchMediumWizard(i18n('wizard.quickmessage.title'), data, 'Send', true);" id="quick_message">
