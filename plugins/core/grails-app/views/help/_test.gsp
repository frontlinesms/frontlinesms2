...
_Exporting lets you to extract messages from FrontlineSMS Version 2 and format them for use in other programs like Microsoft Excel. Export can also be used to create a backup of the selected messages so that you have a copy of them should any of your hardware malfunction. You can also export contacts for similar purposes._

---

### [Exporting Messages][1]
...
[Inbox][2], [Sent][3], [Pending][4], [Inbox Archive][5], [Sent Archive][6]: There is a button in the header called "Export". This will export all messages in the respective folder
SCREENSHOT
...
1.  When viewing "All Contacts" in the [Contacts][12] tab, the export button can be found in the contact header:
SCREENSHOT
...
#### [Exporting a Group of Contacts][15]

1.  Navigate to the [group][13] you wish to export in the contacts tab. The export button can be found in the group header:
SCREENSHOT
...
#### [Exporting a Smart Group of Contacts][16]

1.  Navigate to the [smart group][12] you wish to export in the contacts tab. The export button can be found in the group header:
SCREENSHOT
...
[9]: gotoSearch
[10]: TechTip
[11]: ExportingContacts
[12]: gotoContacts
[13]: gotoCreateGroup
[14]: gotoCreateSmartGroup
[15]: ExportingGroup
[16]: ExportingSmartGroup
[17]: gotoMovingReplyingDeletingForwarding
[18]: gotoArchive
