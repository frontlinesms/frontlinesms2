<div class="section-header">
	<g:if test="${contactsSection instanceof frontlinesms2.Group || contactsSection instanceof frontlinesms2.SmartGroup}">
		...
		<ul class="header-buttons">
			<g:if test="${contactsSection instanceof frontlinesms2.Group}">
				<li>
					<g:remoteLink class="btn" controller="export" action="contactWizard" params="[groupId: contactsSection?.id, contactsSection:contactsSection instanceof frontlinesms2.Group ? 'group' : 'smartGroup']" onSuccess="launchSmallPopup(i18n('smallpopup.contact.export.title'), data, 'Export')"><g:message code="contact.export" /></g:remoteLink>
				</li>
				<li>
	...
	<g:else>
		...
		<ul class="header-buttons">
			<li>
				<g:remoteLink class="btn" controller="export" action="contactWizard" onSuccess="launchSmallPopup(i18n('smallpopup.contact.export.title'), data, 'Export')"><g:message code="contact.export" /></g:remoteLink>
			</li>
		</ul>
	</g:else>
</div>
