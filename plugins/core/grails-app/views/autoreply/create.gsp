...
<div id="tabs" class="vertical-tabs">
	...
	<ol>
		<li><a class="tabs-1" href="#tabs-1"><g:message code="autoreply.create.menu.keyword" /></a></li>
		<li><a class="tabs-2" href="#tabs-2"><g:message code="autoreply.create.menu.message" /></a></li>
		<li><a class="tabs-3" href="#tabs-3"><g:message code="autoreply.create.menu.confirm" /></a></li>
	</ol>
